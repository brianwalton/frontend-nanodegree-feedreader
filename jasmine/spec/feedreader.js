...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function () {
      ...
      beforeEach(function (done) {
         // Empty the current entries from the container and save the new link count
         $('div.feed').empty();
      ...
      it('loadFeed adds at least one entry to feed container', function (done) {
         // Check that the container was empty before but now has new entries
         expect(containerLinkCount).toBe(0);
         expect($('div.feed a').length).toBeGreaterThan(0);
         done();
      });
    ...
    describe('New Feed', function () {
         ...
         */
         ...
         it('loadFeed actually changes content', function (done) {
            // Make sure something was collected in beforeEach
